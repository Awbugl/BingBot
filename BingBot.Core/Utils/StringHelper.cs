...
internal static class StringHelper
{
    ...
    internal static bool Contains(string? raw, string? seed)
        => seed != null && raw != null && Reg.Replace(raw, "").Contains(Reg.Replace(seed, ""), StringComparison.OrdinalIgnoreCase);

    internal static bool Equals(string? raw, string? seed)
        => seed != null && raw != null && string.Equals(Reg.Replace(raw, ""), Reg.Replace(seed, ""), StringComparison.OrdinalIgnoreCase);
}
